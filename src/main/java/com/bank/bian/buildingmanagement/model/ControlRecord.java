package com.bank.bian.buildingmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Facility Operating Session".
 *
 ...
 * to its asset type (Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Facility Operating Session";
